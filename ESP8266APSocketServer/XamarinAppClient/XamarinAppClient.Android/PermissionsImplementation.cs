    ...
    public class PermissionsImplementation : IPermissions
    {
        ...
        static Permission GetPermissionForManifestName(string permission)
        {
            switch (permission)
            {
                ...
                case Manifest.Permission.InternalSystemWindow:
                case Manifest.Permission.SystemAlertWindow:
                    return Permission.Overlay;
            }
        ...
        List<string> GetManifestNames(Permission permission)
        {
            ...
            switch(permission)
            {
                ...
                case Permission.Overlay:
                    {
                        if (HasPermissionInManifest(Manifest.Permission.SystemAlertWindow))
                            permissionNames.Add(Manifest.Permission.SystemAlertWindow);
                        if (HasPermissionInManifest(Manifest.Permission.InternalSystemWindow))
                            permissionNames.Add(Manifest.Permission.InternalSystemWindow);
                    }
                    break;
                default:
                    return null;
